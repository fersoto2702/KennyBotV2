...
const iconPath = path.join(__dirname, '../../assets/icons/work.jpeg')

const cooldowns = new Map()

const JOBS = [
    'Programador 💻', 'Taxista 🚕', 'Doctor 🩺',
    'Policía 👮', 'Chef 👨‍🍳', 'Streamer 🎮',
    'Youtuber 📹', 'Hacker 🖥️'
]
...
module.exports = {
    ...
    async execute({ sock, from, msg }) {
        ...
        try {
            ...
            if (cooldowns.has(sender)) {
                ...
                if (now < expires) {
                    ...
                    return await sock.sendMessage(from, {
                        ...
                        caption: ui.warn('YA TRABAJASTE', `Vuelve en ${mins} minutos.`)
                    })
                }
            }
            ...
            logger.event(`Work: ${sender.split('@')[0]} +${amount} (${job})`)

            await sock.sendMessage(from, {
                image: fs.readFileSync(iconPath),
                caption: ui.success('TRABAJO COMPLETADO', [
            ...
            logger.error(`Error work: ${err.message}`)
        }
